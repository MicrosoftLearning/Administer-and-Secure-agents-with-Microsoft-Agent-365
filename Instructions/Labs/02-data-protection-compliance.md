...
**Note**: The sensitivity label may take up 2 hours or less to apply. The recomendation is to move on to the next task. 
...
**Note**: the label may take 30 minutes or less to apply to this document.
...
1. Navigate to https://m365.cloud.microsoft/chat? and login as **Amber Rodriguez** with the password provided.
   ...
   **Note:** The provided user password may not work. If that is the case, you will need to reset Amber's password by going to the Microsoft 365 admin center as the MOD Admin > **Users** > **Active Users** > Select **Amber Rodriguez** > select **Reset Password** > ensure no checkbox is selected > type in a password of your choosing > select **Reset Password**.
